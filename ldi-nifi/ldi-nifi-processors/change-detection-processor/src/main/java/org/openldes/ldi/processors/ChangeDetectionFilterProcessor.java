...
import static org.openldes.ldi.processors.config.ChangeDetectionFilterProperties.DATA_SOURCE_FORMAT;
import static org.openldes.ldi.processors.config.ChangeDetectionFilterProperties.getDataSourceFormat;
import static org.openldes.ldi.processors.config.ChangeDetectionFilterRelationships.IGNORED;
import static org.openldes.ldi.processors.config.ChangeDetectionFilterRelationships.NEW_STATE_RECEIVED;
import static org.openldes.ldi.processors.config.PersistenceProperties.*;

@SuppressWarnings("java:S2160") // nifi handles equals/hashcode of processors
@Tags({"change-detection-filter", "openldes"})
