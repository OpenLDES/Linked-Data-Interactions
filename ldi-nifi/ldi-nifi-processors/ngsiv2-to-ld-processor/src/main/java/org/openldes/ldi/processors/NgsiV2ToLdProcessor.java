...
import org.openldes.ldi.processors.config.NgsiV2ToLdProcessorProperties;
...
import static org.openldes.ldi.processors.config.NgsiV2ToLdProcessorProperties.CORE_CONTEXT;
import static org.openldes.ldi.processors.config.NgsiV2ToLdProcessorProperties.DATA_IDENTIFIER;
import static org.openldes.ldi.processors.config.NgsiV2ToLdProcessorProperties.LD_CONTEXT;
import static org.openldes.ldi.processors.services.FlowManager.FAILURE;
import static org.openldes.ldi.processors.services.FlowManager.SUCCESS;

@SuppressWarnings("java:S2160") // nifi handles equals/hashcode of processors
@Tags({ "ngsiv2-to-ld", "ldes", "openldes" })
