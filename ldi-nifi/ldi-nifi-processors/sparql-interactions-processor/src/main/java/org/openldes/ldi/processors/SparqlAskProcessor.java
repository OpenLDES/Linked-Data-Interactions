...
import static org.openldes.ldi.processors.config.CommonProperties.DATA_SOURCE_FORMAT;
import static org.openldes.ldi.processors.config.CommonProperties.getDataSourceFormat;
import static org.openldes.ldi.processors.config.SparqlAskRelationships.FALSE;
import static org.openldes.ldi.processors.config.SparqlAskRelationships.TRUE;
import static org.openldes.ldi.processors.config.SparqlProcessorProperties.SPARQL_ASK_QUERY;
import static org.openldes.ldi.processors.services.FlowManager.FAILURE;
import static org.openldes.ldi.processors.services.FlowManager.receiveDataAsModel;

@SuppressWarnings("java:S2160") // nifi handles equals/hashcode of processors
@Tags({"ldes", "openldes", "SPARQL"})
