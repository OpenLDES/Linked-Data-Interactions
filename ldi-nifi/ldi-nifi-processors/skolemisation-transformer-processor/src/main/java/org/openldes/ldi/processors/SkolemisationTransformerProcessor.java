...
import static org.openldes.ldi.processors.config.SkolemisationTransformerProperties.SKOLEM_DOMAIN;
import static org.openldes.ldi.processors.config.SkolemisationTransformerProperties.getSkolemDomain;
import static org.openldes.ldi.processors.services.FlowManager.*;

@SuppressWarnings("java:S2160") // nifi handles equals/hashcode of processors
@Tags({"skolemisation", "openldes", "ldes"})
