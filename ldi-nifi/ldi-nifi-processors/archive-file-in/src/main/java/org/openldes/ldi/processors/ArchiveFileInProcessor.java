...
import static org.openldes.ldi.processors.config.ArchiveFileInProperties.ARCHIVE_ROOT_DIR;
import static org.openldes.ldi.processors.config.ArchiveFileInProperties.getArchiveRootDirectory;
...
@Tags({ "ldes, openldes, archive, file" })
