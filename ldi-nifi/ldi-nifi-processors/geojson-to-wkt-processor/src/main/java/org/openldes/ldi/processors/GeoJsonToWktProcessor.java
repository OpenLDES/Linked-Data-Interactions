...
import static org.openldes.ldi.processors.config.GeoJsonToWktProcessorProperties.TRANSFORM_TO_RDF_WKT;
import static org.openldes.ldi.processors.config.GeoJsonToWktProcessorProperties.getTransformToRdfWkt;
import static org.openldes.ldi.processors.services.FlowManager.*;

@SuppressWarnings("java:S2160") // nifi handles equals/hashcode of processors
@Tags({ "ldes, openldes, geojson, wkt" })
